/**
 * Tombstone collateral (docs/cloud-sync-design.md §10.2 applier): which
 * same-name cookies Electron's cookies.remove(url, name) may take out with
 * the target, which of them vanished, and how they are put back through the
 * protocol's exact set mapping.
 */

import { describe, expect, it } from "vitest";
import type { CookieIdentity, ElectronCookie } from "@pistachio/sync-protocol";
import { collateralFor, lostCollateral, matchesTarget, restoreDetailsFor } from "../src/main/sync/collateral";
