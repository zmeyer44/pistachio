/**
 * Recovery-code wrapper storage. Control stores only the PBKDF2 salt and the
 * wrapped root secret — KEK derivation and unwrap happen client-side, so the
 * server never sees the recovery code or any key.
 */
