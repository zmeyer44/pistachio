...
/**
 * Default for origins outside the tested corpus (D17): synced at tier 1 with
 * LWW (not rotating-auth), never sensitive, reauth is one-touch when the
 * restored session is challenged.
 */
