...
/**
 * base64url without padding (RFC 4648 §5) — the encoding every compact JWS
 * part, JWK component, and credential MAC in this repo uses. One definition:
 * an encoder and decoder that disagree by a single padding character silently
