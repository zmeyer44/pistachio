...
// Phosphor Icons 2.1.1 (MIT), fill variants; dismiss uses the regular outline.
// Original icon geometry. See media-icons.LICENSE.txt.
export type MediaIcon = ComponentType<SVGProps<SVGSVGElement>>;

export const Play: MediaIcon = (props) => (
  <svg viewBox="0 0 256 256" fill="currentColor" focusable="false" {...props}>
    <path d="M240,128a15.74,15.74,0,0,1-7.6,13.51L88.32,229.65a16,16,0,0,1-16.2.3A15.86,15.86,0,0,1,64,216.13V39.87a15.86,15.86,0,0,1,8.12-13.82,16,16,0,0,1,16.2.3L232.4,114.49A15.74,15.74,0,0,1,240,128Z" />
  </svg>
);
export const Pause: MediaIcon = (props) => (
  <svg viewBox="0 0 256 256" fill="currentColor" focusable="false" {...props}>
    <path d="M216,48V208a16,16,0,0,1-16,16H160a16,16,0,0,1-16-16V48a16,16,0,0,1,16-16h40A16,16,0,0,1,216,48ZM96,32H56A16,16,0,0,0,40,48V208a16,16,0,0,0,16,16H96a16,16,0,0,0,16-16V48A16,16,0,0,0,96,32Z" />
  </svg>
);
export const Volume2: MediaIcon = (props) => (
  <svg viewBox="0 0 256 256" fill="currentColor" focusable="false" {...props}>
...
export const VolumeX: MediaIcon = (props) => (
  <svg viewBox="0 0 256 256" fill="currentColor" focusable="false" {...props}>
...
export const SkipBack: MediaIcon = (props) => (
  <svg viewBox="0 0 256 256" fill="currentColor" focusable="false" {...props}>
...
export const SkipForward: MediaIcon = (props) => (
  <svg viewBox="0 0 256 256" fill="currentColor" focusable="false" {...props}>
...
export const RotateBack: MediaIcon = (props) => (
  <svg viewBox="0 0 256 256" fill="currentColor" focusable="false" {...props}>
...
// The 15-second seeks: Phosphor's counter-clockwise / clockwise arrows with
// the step set inside the ring, drawn a little larger than the other controls
// (see `.media-seek-icon`) so the numeral stays legible.
const SeekNumeral = ({ x }: { x: number }) => (
  <text
    x={x}
    y={131}
    textAnchor="middle"
...
export const Back15: MediaIcon = (props) => (
  <svg
    viewBox="0 0 256 256"
    fill="currentColor"
    focusable="false"
    className="media-seek-icon"
    {...props}
  >
    <path d="M224,128a96,96,0,0,1-94.71,96H128A95.38,95.38,0,0,1,62.1,197.8a8,8,0,0,1,11-11.63A80,80,0,1,0,71.43,71.39a3.07,3.07,0,0,1-.26.25L60.63,81.29l17,17A8,8,0,0,1,72,112H24a8,8,0,0,1-8-8V56A8,8,0,0,1,29.66,50.3L49.31,70,60.25,60A96,96,0,0,1,224,128Z" />
    <SeekNumeral x={132} />
...
export const Forward15: MediaIcon = (props) => (
  <svg
    viewBox="0 0 256 256"
    fill="currentColor"
    focusable="false"
...
export const ExternalLink: MediaIcon = (props) => (
  <svg viewBox="0 0 256 256" fill="currentColor" focusable="false" {...props}>
...
export const PictureInPicture2: MediaIcon = (props) => (
  <svg viewBox="0 0 256 256" fill="currentColor" focusable="false" {...props}>
...
export const Highlighter: MediaIcon = (props) => (
  <svg viewBox="0 0 256 256" fill="currentColor" focusable="false" {...props}>
...
export const Music2: MediaIcon = (props) => (
  <svg viewBox="0 0 256 256" fill="currentColor" focusable="false" {...props}>
...
export const Video: MediaIcon = (props) => (
  <svg viewBox="0 0 256 256" fill="currentColor" focusable="false" {...props}>
...
export const Radio: MediaIcon = (props) => (
  <svg viewBox="0 0 256 256" fill="currentColor" focusable="false" {...props}>
...
export const Gauge: MediaIcon = (props) => (
  <svg viewBox="0 0 256 256" fill="currentColor" focusable="false" {...props}>
